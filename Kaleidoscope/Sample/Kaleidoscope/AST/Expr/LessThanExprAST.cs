...
public class LessThanExprAST : BooleanExprAST
{

    public CodegenLLVMSharpEleNode LHS;
    public CodegenLLVMSharpEleNode RHS;

    public LessThanExprAST(CodegenLLVMSharpEleNode LHS, CodegenLLVMSharpEleNode RHS)
    {
        this.LHS = LHS;
        this.RHS = RHS;
    }

    public override unsafe PreLessThanInst Codegen()
    {
    ...
    {
        var result = "";
        result += "LessThanExprAST {".ToStr(printer) + "\n";
